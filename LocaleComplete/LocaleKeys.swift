...
public enum LocaleKeys: String {
    ...
    case englishBosniaAndHerzegovina = "en_BA"
    ...
    /// Spanish (Antigua & Barbuda)
    case spanishAntiguaAndBarbuda = "es_AG"
    ...
    /// Spanish (St. Kitts & Nevis)
    case spanishStKittsAndNevis = "es_KN"

    /// Spanish (Cayman Islands)
    ...
    /// Spanish (St. Pierre & Miquelon)
    case spanishStPierreAndMiquelon = "es_PM"
    ...
    /// Spanish (Turks & Caicos Islands)
    case spanishTurksAndCaicosIslands = "es_TC"

    /// Spanish (Trinidad & Tobago)
    case spanishTrinidadAndTobago = "es_TT"
    ...
    /// Spanish (St. Vincent & Grenadines)
    case spanishStVincentAndGrenadines = "es_VC"
    ...
    /// Fulah (Latin)
    case fulahLatin = "ff_Latn"

    /// Fulah (Latin, Burkina Faso)
    case fulahLatinBurkinaFaso = "ff_Latn_BF"

    /// Fulah (Latin, Cameroon)
    case fulahLatinCameroon = "ff_Latn_CM"

    /// Fulah (Latin, Ghana)
    case fulahLatinGhana = "ff_Latn_GH"

    /// Fulah (Latin, Gambia)
    case fulahLatinGambia = "ff_Latn_GM"

    /// Fulah (Latin, Guinea)
    case fulahLatinGuinea = "ff_Latn_GN"

    /// Fulah (Latin, Guinea-Bissau)
    case fulahLatinGuineaBissau = "ff_Latn_GW"

    /// Fulah (Latin, Liberia)
    case fulahLatinLiberia = "ff_Latn_LR"

    /// Fulah (Latin, Mauritania)
    case fulahLatinMauritania = "ff_Latn_MR"

    /// Fulah (Latin, Niger)
    case fulahLatinNiger = "ff_Latn_NE"

    /// Fulah (Latin, Nigeria)
    case fulahLatinNigeria = "ff_Latn_NG"

    /// Fulah (Latin, Sierra Leone)
    case fulahLatinSierraLeone = "ff_Latn_SL"

    /// Fulah (Latin, Senegal)
    case fulahLatinSenegal = "ff_Latn_SN"
    ...
    /// Kashmiri (Naskh, India)
    case kashmiriNaskhIndia = "ks_Arab_IN"

    /// Kashmiri (Nastaliq)
    case kashmiriNastaliq = "ks_Aran"

    /// Kashmiri (Nastaliq, India)
    case kashmiriNastaliqIndia = "ks_Aran_IN"
    ...
    /// Punjabi (Naskh, Pakistan)
    case punjabiNaskhPakistan = "pa_Arab_PK"

    /// Punjabi (Nastaliq)
    case punjabiNastaliq = "pa_Aran"

    /// Punjabi (Nastaliq, Pakistan)
    ...
    /// Urdu (Nastaliq)
    case urduNastaliq = "ur_Aran"

    /// Urdu (Nastaliq, India)
    case urduNastaliqIndia = "ur_Aran_IN"

    /// Urdu (Nastaliq, Pakistan)
    case urduNastaliqPakistan = "ur_Aran_PK"
    ...
    /// Cantonese, Simplified (China mainland)
    case cantoneseSimplifiedChinamainland = "yue_Hans_CN"

    /// Cantonese, Traditional
    case cantoneseTraditional = "yue_Hant"

    /// Cantonese, Traditional (Hong Kong)
    case cantoneseTraditionalHongKong = "yue_Hant_HK"


    // MARK:- Standard Moroccan Tamazight
    ...
    case chineseSimplifiedChinamainland = "zh_Hans_CN"
    ...
    /// Chinese, Traditional (China mainland)
    case chineseTraditionalChinamainland = "zh_Hant_CN"

    /// Chinese, Traditional (Hong Kong)
    case chineseTraditionalHongKong = "zh_Hant_HK"

    /// Chinese, Traditional (Macao)
    case chineseTraditionalMacao = "zh_Hant_MO"
